...
describe(`Advent of Code Day ${solution.dayNumber}`, () => {
  ...
  it('should read input', () => {
    ...
    expect(school.fish).toStrictEqual([3,4,3,1,2]);
    expect(school.day).toBe(0);

    expect(school.nextDay()).toBe(1);
    expect(school.fish).toStrictEqual([2,3,2,0,1]);

    expect(school.nextDay()).toBe(2);
    expect(school.fish).toStrictEqual([1,2,1,6,0,8]);

    expect(school.nextDay()).toBe(3);
    expect(school.fish).toStrictEqual([0,1,0,5,6,7,8]);

    expect(school.nextDay()).toBe(4);
    expect(school.fish).toStrictEqual([6,0,6,4,5,6,7,8,8]);

    expect(school.nextDay()).toBe(5);
    expect(school.fish).toStrictEqual([5,6,5,3,4,5,6,7,7,8]);

    expect(school.nextDay()).toBe(6);
    expect(school.fish).toStrictEqual([4,5,4,2,3,4,5,6,6,7]);

    expect(school.nextDay()).toBe(7);
    expect(school.fish).toStrictEqual([3,4,3,1,2,3,4,5,5,6]);

    while(school.nextDay() < 80);

    expect(school.fish.length).toBe(5934);
  });
